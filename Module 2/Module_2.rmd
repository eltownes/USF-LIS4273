...
The datasets' measure of center show the difference in their
numeric values - there's a clear difference. The measures of variation broadly show the degree to which they vary; it hints at little variation - only the 
range
provides a clue what the underlying values may look
like.
<br><br>

### GitHub
Get the related file(s) on <a href="https://github.com/eltownes/USF-LIS4273/tree/master/Module%202">Git Me</a>
<br><br>